...
int delegate_real_com_util_file_write(com_util_file *file, const void *buf, size_t len)
{
...
MOCK_WEAK_IMPL(int, com_util_file_write, com_util_file *file, const void *buf, size_t len)
{
    int rtc = -1;
