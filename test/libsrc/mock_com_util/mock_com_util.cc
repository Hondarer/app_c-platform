...
Mock_com_util::Mock_com_util()
{
    ...
    ON_CALL(*this, com_util_argparser_handle_register_option_int(_, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_option_int));
    ON_CALL(*this, com_util_argparser_handle_register_option_string(_, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_option_string));
    ON_CALL(*this, com_util_argparser_handle_register_option_int_array(_, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_option_int_array));
    ON_CALL(*this, com_util_argparser_handle_register_option_string_array(_, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_option_string_array));
    ON_CALL(*this, com_util_argparser_handle_register_positional_int(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_positional_int));
    ON_CALL(*this, com_util_argparser_handle_register_positional_string(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_register_positional_string));
    ON_CALL(*this, com_util_argparser_handle_register_positional_int_array(_, _, _, _, _, _, _))
    ...
    ON_CALL(*this, com_util_argparser_handle_get_error_index(_))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_error_index));
    ON_CALL(*this, com_util_argparser_handle_get_error_message(_, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_error_message));
    ON_CALL(*this, com_util_argparser_handle_get_usage(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_usage));
    ON_CALL(*this, com_util_argparser_handle_print_usage(_, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_print_usage));
    ON_CALL(*this, com_util_argparser_handle_print_error_messages(_, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_print_error_messages));
    ON_CALL(*this, com_util_argparser_handle_get_register_error(_, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_register_error));
    ON_CALL(*this, com_util_argparser_handle_get_register_error_count(_))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_register_error_count));
    ON_CALL(*this, com_util_argparser_handle_get_register_error_target(_, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_register_error_target));
    ON_CALL(*this, com_util_argparser_handle_get_register_error_message(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_com_util_argparser_handle_get_register_error_message));
    ON_CALL(*this, com_util_argparser_handle_print_register_error_messages(_, _))
