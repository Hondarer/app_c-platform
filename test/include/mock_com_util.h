...
extern int delegate_real_com_util_mutex_lock(com_util_mutex_t *mtx);
extern int delegate_real_com_util_mutex_timedlock(com_util_mutex_t *mtx, uint32_t timeout_ms);
extern int delegate_real_com_util_mutex_unlock(com_util_mutex_t *mtx);
extern int delegate_real_com_util_mutex_destroy(com_util_mutex_t *mtx);
extern int delegate_real_com_util_condvar_init(com_util_condvar_t *cv);
extern int delegate_real_com_util_condvar_wait(com_util_condvar_t *cv, com_util_mutex_t *mtx);
extern int delegate_real_com_util_condvar_timedwait(com_util_condvar_t *cv, com_util_mutex_t *mtx, uint32_t timeout_ms);
extern int delegate_real_com_util_condvar_signal(com_util_condvar_t *cv);
extern int delegate_real_com_util_condvar_broadcast(com_util_condvar_t *cv);
extern int delegate_real_com_util_condvar_destroy(com_util_condvar_t *cv);
extern int delegate_real_com_util_rwlock_init(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_rwlock_lock_shared(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_rwlock_timedlock_shared(com_util_rwlock_t *rwlock, uint32_t timeout_ms);
extern int delegate_real_com_util_rwlock_lock_exclusive(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_rwlock_unlock_shared(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_rwlock_unlock_exclusive(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_rwlock_destroy(com_util_rwlock_t *rwlock);
extern int delegate_real_com_util_thread_create(com_util_thread_t *thread, com_util_thread_func_t func, void *arg);
extern void delegate_real_com_util_thread_join(com_util_thread_t *thread);
extern int delegate_real_com_util_thread_join_timed(com_util_thread_t *thread, uint32_t timeout_ms);
extern int delegate_real_com_util_thread_detach(com_util_thread_t *thread);
