 ...
 *  一致させます。
 *
 *  本ヘッダーは C++ 専用であり、`cplat_internal.h` には含めません。
 *
...
#ifndef CPLAT_REGEX_REGEX_UTF8_H
#define CPLAT_REGEX_REGEX_UTF8_H
 ...
 *
 *  オーバー ロング表現、単独のサロゲート、U+10FFFF を超える値、
...
#endif /* CPLAT_REGEX_REGEX_UTF8_H */
