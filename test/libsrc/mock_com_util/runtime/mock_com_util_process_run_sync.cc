...
int delegate_real_com_util_process_run_sync(const com_util_process_options_t *options, int timeout_ms, int *exit_code)
{
...
MOCK_WEAK_IMPL(int, com_util_process_run_sync, const com_util_process_options_t *options, int timeout_ms,
               int *exit_code)
{
