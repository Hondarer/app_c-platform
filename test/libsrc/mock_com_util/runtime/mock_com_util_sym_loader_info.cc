...
int delegate_real_com_util_sym_loader_info(com_util_sym_loader_entry_t *const *fobj_array, size_t fobj_length)
{
    static auto real_fn =
        reinterpret_cast<decltype(&com_util_sym_loader_info)>(
