 ...
 *******************************************************************************
 *  @file           wchar_conv.h
 *  @brief          UTF-8 / ワイド文字列変換 API (Windows 専用)。
 *  @author         Tetsuo Honda
 *  @date           2026/06/09
 *  @version        1.0.0
 *
...
/**
 *  @brief          ワイド文字列パスを UTF-8 に変換する。
 *  @details        変換後の文字列中の `\\` を `/` に正規化します。
...
/**
 *  @brief          UTF-8 文字列をワイド文字列に変換し、malloc で確保して返す。
...
/**
 *  @brief          ワイド文字列を UTF-8 に変換し、malloc で確保して返す。
