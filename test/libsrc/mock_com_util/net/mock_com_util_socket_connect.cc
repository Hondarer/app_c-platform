...
int delegate_real_com_util_socket_connect(com_util_socket sock, const com_util_ipv4_endpoint *endpoint, com_util_error *detail_out)
{
    static auto real_fn =
        reinterpret_cast<decltype(&com_util_socket_connect)>(resolveSharedSymbolOrExit(kLibComUtilName, "com_util_socket_connect"));
