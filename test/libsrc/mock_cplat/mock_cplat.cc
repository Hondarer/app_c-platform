...
Mock_cplat::Mock_cplat()
{
    ...
    ON_CALL(*this, cplat_argparser_handle_create(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_argparser_handle_create));
    ON_CALL(*this, cplat_argparser_init(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_argparser_init));
    ON_CALL(*this, cplat_argparser_handle_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_argparser_handle_dispose));
    ...
    ON_CALL(*this, cplat_argparser_handle_parse(_))
        .WillByDefault(Invoke(delegate_real_cplat_argparser_handle_parse));
    ON_CALL(*this, cplat_argparser_parse())
        .WillByDefault(Invoke(delegate_real_cplat_argparser_parse));
    ON_CALL(*this, cplat_argparser_handle_get_error(_))
        .WillByDefault(Invoke(delegate_real_cplat_argparser_handle_get_error));
    ...
    ON_CALL(*this, cplat_hashtable_validate(_))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_validate));
    ...
    ON_CALL(*this, cplat_hashtable_add(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_add));
    ...
    ON_CALL(*this, cplat_hashtable_update(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_update));
    ...
    ON_CALL(*this, cplat_hashtable_count(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_count));
    ...
    ON_CALL(*this, cplat_hashtable_delete(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_delete));
    ...
    ON_CALL(*this, cplat_hashtable_compact(_))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_compact));
    ON_CALL(*this, cplat_hashtable_resize(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_resize));
    ON_CALL(*this, cplat_hashtable_rebuild_into(_, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_rebuild_into));
    ON_CALL(*this, cplat_hashtable_clear(_))
        .WillByDefault(Invoke(delegate_real_cplat_hashtable_clear));
    ON_CALL(*this, cplat_hashtable_dispose(_))
    ...
    ON_CALL(*this, cplat_timespec_normalize(_))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_normalize));
    ON_CALL(*this, cplat_timespec_add(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_add));
    ON_CALL(*this, cplat_timespec_sub(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_sub));
    ON_CALL(*this, cplat_timespec_cmp(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_cmp));
    ON_CALL(*this, cplat_timespec_add_ms(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_add_ms));
    ON_CALL(*this, cplat_timespec_diff_ms(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_diff_ms));
    ON_CALL(*this, cplat_timespec_to_native(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_timespec_to_native));
    ...
    ON_CALL(*this, cplat_vopen_fmt(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_open_fmt));

    // cplat/crt/file.h
    ON_CALL(*this, cplat_file_init(_)).WillByDefault(Invoke(delegate_real_cplat_file_init));
    ON_CALL(*this, cplat_file_open(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_open));
    ON_CALL(*this, cplat_file_write(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_write));
    ON_CALL(*this, cplat_file_read(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_read));
    ON_CALL(*this, cplat_file_get_size(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_get_size));
    ON_CALL(*this, cplat_file_set_size(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_set_size));
    ON_CALL(*this, cplat_file_get_id(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_get_id));
    ON_CALL(*this, cplat_file_get_path_id(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_file_get_path_id));
    ...
    ON_CALL(*this, cplat_path_dirname(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_path_dirname));
    ON_CALL(*this, cplat_path_extension(_))
        .WillByDefault(Invoke(delegate_real_cplat_path_extension));
    ON_CALL(*this, cplat_path_strip_extension(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_path_strip_extension));
    ON_CALL(*this, cplat_path_join_n(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_vpath_join_n));
    ON_CALL(*this, cplat_vpath_join_n(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_vpath_join_n));
    ...
    ON_CALL(*this, cplat_fopen_temp(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_fopen_temp));
    ...
    ON_CALL(*this, cplat_parse_int64(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_parse_int64));
    ON_CALL(*this, cplat_parse_uint64(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_parse_uint64));
    ON_CALL(*this, cplat_parse_int(_, _, _)).WillByDefault(Invoke(delegate_real_cplat_parse_int));
    ON_CALL(*this, cplat_parse_double(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_parse_double));
    ON_CALL(*this, cplat_malloc(_)).WillByDefault(Invoke(delegate_real_cplat_malloc));
    ON_CALL(*this, cplat_malloc_zerofill(_))
        .WillByDefault(Invoke(delegate_real_cplat_malloc_zerofill));
    ...
    ON_CALL(*this, cplat_strncasecmp(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_strncasecmp));
    ...
    ON_CALL(*this, cplat_file_stat_is_regular(_))
        .WillByDefault(Invoke(delegate_real_cplat_file_stat_is_regular));
    ...
    ON_CALL(*this, cplat_vaccess_fmt(_, _, _))
    ...
    // cplat/base/error.h
    ON_CALL(*this, cplat_error_clear(_)).WillByDefault(Invoke(delegate_real_cplat_error_clear));
    ON_CALL(*this, cplat_error_capture_errno(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_error_capture_errno));
    ON_CALL(*this, cplat_error_capture_current_errno(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_capture_current_errno));
    ON_CALL(*this, cplat_error_get_last(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_get_last));
    ON_CALL(*this, cplat_error_set_last(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_set_last));
    ON_CALL(*this, cplat_error_clear_last())
        .WillByDefault(Invoke(delegate_real_cplat_error_clear_last));
    ON_CALL(*this, cplat_error_is_set(_)).WillByDefault(Invoke(delegate_real_cplat_error_is_set));
    ON_CALL(*this, cplat_error_get_domain(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_get_domain));
    ON_CALL(*this, cplat_error_get_errno(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_get_errno));
    ON_CALL(*this, cplat_error_to_result(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_to_result));
    ON_CALL(*this, cplat_error_get_cause(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_get_cause));
    ON_CALL(*this, cplat_error_is(_, _)).WillByDefault(Invoke(delegate_real_cplat_error_is));

    // cplat/base/error_message.h
    ON_CALL(*this, cplat_result_to_string(_))
        .WillByDefault(Invoke(delegate_real_cplat_result_to_string));
    ON_CALL(*this, cplat_error_message(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_error_message));
    ...
    ON_CALL(*this, cplat_ipv4_resolve(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_ipv4_resolve));
    ON_CALL(*this, cplat_ipv4_to_string(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_ipv4_to_string));

    // cplat/net/socket.h
    ON_CALL(*this, cplat_socket_open(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_open));
    ON_CALL(*this, cplat_socket_close(_)).WillByDefault(Invoke(delegate_real_cplat_socket_close));
    ON_CALL(*this, cplat_socket_shutdown(_))
        .WillByDefault(Invoke(delegate_real_cplat_socket_shutdown));
    ON_CALL(*this, cplat_socket_bind(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_bind));
    ON_CALL(*this, cplat_socket_listen(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_listen));
    ON_CALL(*this, cplat_socket_accept(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_accept));
    ON_CALL(*this, cplat_socket_connect(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_connect));
    ...
    ON_CALL(*this, cplat_socket_send(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_send));
    ON_CALL(*this, cplat_socket_recv(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_recv));
    ...
    ON_CALL(*this, cplat_socket_send_all(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_send_all));
    ON_CALL(*this, cplat_socket_recv_all(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_socket_recv_all));
    ...
    ON_CALL(*this, cplat_pinned_prompt_create(_))
        .WillByDefault(Invoke(delegate_real_cplat_pinned_prompt_create));
    ...
    ON_CALL(*this, cplat_prompt_dispose(_))
    ...
    ON_CALL(*this, cplat_regex_create(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_create));
    ON_CALL(*this, cplat_regex_dispose(_)).WillByDefault(Invoke(delegate_real_cplat_regex_dispose));
    ON_CALL(*this, cplat_regex_get_group_count(_))
        .WillByDefault(Invoke(delegate_real_cplat_regex_get_group_count));
    ON_CALL(*this, cplat_regex_search(_, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_search));
    ON_CALL(*this, cplat_regex_matches(_, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_matches));
    ON_CALL(*this, cplat_regex_replace(_, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_replace));
    ON_CALL(*this, cplat_regex_iter_create(_, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_iter_create));
    ON_CALL(*this, cplat_regex_iter_next(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_iter_next));
    ON_CALL(*this, cplat_regex_iter_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_regex_iter_dispose));
    ON_CALL(*this, cplat_regex_split(_, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_regex_split));

    // cplat/runtime/memory_lock.h
    ON_CALL(*this, cplat_memory_lock_range(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_memory_lock_range));
    ON_CALL(*this, cplat_memory_unlock_range(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_memory_unlock_range));
    ON_CALL(*this, cplat_memory_lock_self(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_memory_lock_self));
    ...
    ON_CALL(*this, cplat_host_get_name(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_host_get_name));

    // cplat/runtime/module.h
    ON_CALL(*this, cplat_module_get_path(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_module_get_path));
    ...
    ON_CALL(*this, cplat_process_wait(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_process_wait));
    ON_CALL(*this, cplat_process_get_exit_code(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_process_get_exit_code));
    ON_CALL(*this, cplat_process_terminate(_))
        .WillByDefault(Invoke(delegate_real_cplat_process_terminate));
    ON_CALL(*this, cplat_process_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_process_dispose));
    ON_CALL(*this, cplat_process_run_sync(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_process_run_sync));

    // cplat/runtime/shutdown.h
    ON_CALL(*this, cplat_shutdown_register(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_shutdown_register));
    ON_CALL(*this, cplat_shutdown_request_register(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_shutdown_request_register));
    ON_CALL(*this, cplat_exit(_)).WillByDefault(Invoke(delegate_real_cplat_exit));
    ON_CALL(*this, cplat_shutdown_invoke_for_test(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_shutdown_invoke_for_test));
    ON_CALL(*this, cplat_shutdown_request_invoke_for_test(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_shutdown_request_invoke_for_test));
    ON_CALL(*this, cplat_shutdown_reset_for_test())
        .WillByDefault(Invoke(delegate_real_cplat_shutdown_reset_for_test));

    // cplat/runtime/sym_loader.h
    ON_CALL(*this, cplat_sym_loader_resolve(_))
        .WillByDefault(Invoke(delegate_real_cplat_sym_loader_resolve));
    ON_CALL(*this, cplat_sym_loader_is_default(_))
        .WillByDefault(Invoke(delegate_real_cplat_sym_loader_is_default));
    ON_CALL(*this, cplat_sym_loader_init(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_sym_loader_init));
    ON_CALL(*this, cplat_sym_loader_dispose(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_sym_loader_dispose));
    ...
    ON_CALL(*this, cplat_local_lock_lock(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_local_lock_lock));
    ON_CALL(*this, cplat_local_lock_try_lock(_))
        .WillByDefault(Invoke(delegate_real_cplat_local_lock_try_lock));
    ON_CALL(*this, cplat_local_lock_unlock(_))
        .WillByDefault(Invoke(delegate_real_cplat_local_lock_unlock));
    ON_CALL(*this, cplat_local_lock_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_local_lock_dispose));
    ON_CALL(*this, cplat_condvar_create(_))
        .WillByDefault(Invoke(delegate_real_cplat_condvar_create));
    ON_CALL(*this, cplat_condvar_wait(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_condvar_wait));
    ON_CALL(*this, cplat_condvar_signal(_))
        .WillByDefault(Invoke(delegate_real_cplat_condvar_signal));
    ON_CALL(*this, cplat_condvar_broadcast(_))
        .WillByDefault(Invoke(delegate_real_cplat_condvar_broadcast));
    ON_CALL(*this, cplat_condvar_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_condvar_dispose));
    ON_CALL(*this, cplat_local_rwlock_create(_))
        .WillByDefault(Invoke(delegate_real_cplat_local_rwlock_create));
    ...
    ON_CALL(*this, cplat_local_rwlock_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_local_rwlock_dispose));
    ON_CALL(*this, cplat_thread_create(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_thread_create));
    ...
    ON_CALL(*this, cplat_tracer_get_state(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_state));
    ON_CALL(*this, cplat_tracer_write_at(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_write_at));
    ON_CALL(*this, cplat_tracer_writef_at(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_writef_at));
    ON_CALL(*this, cplat_tracer_vwritef_at(_, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_vwritef_at));
    ...
    ON_CALL(*this, cplat_tracer_vwrite_hexf_at(_, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_vwrite_hexf_at));
    ON_CALL(*this, cplat_tracer_hex_sep(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_hex_sep));
    ON_CALL(*this, cplat_tracer_hex_msg(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_hex_msg));
    ON_CALL(*this, cplat_tracer_write_with_source(_, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_write_with_source));
    ON_CALL(*this, cplat_tracer_set_name(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_set_name));
    ON_CALL(*this, cplat_tracer_get_name(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_name));
    ON_CALL(*this, cplat_tracer_get_identifier(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_identifier));
    ON_CALL(*this, cplat_tracer_set_file_name(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_set_file_name));
    ON_CALL(*this, cplat_tracer_get_file_name(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_file_name));
    ON_CALL(*this, cplat_tracer_get_file_identifier(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_file_identifier));
    ON_CALL(*this, cplat_tracer_get_os_level(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_os_level));
    ON_CALL(*this, cplat_tracer_set_os_level(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_set_os_level));
    ON_CALL(*this, cplat_tracer_get_etw_level(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_get_etw_level));
    ...
    ON_CALL(*this, cplat_tracer_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_dispose));
    ON_CALL(*this, cplat_tracer_set_hook(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_set_hook));
    ON_CALL(*this, cplat_tracer_remove_hook(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_tracer_remove_hook));
    ...
    ON_CALL(*this, cplat_utf8_to_wpath(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_utf8_to_wpath));
    ON_CALL(*this, cplat_utf8_to_wstr(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_utf8_to_wstr));
    ON_CALL(*this, cplat_wpath_to_utf8(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_wpath_to_utf8));
    ON_CALL(*this, cplat_wstr_to_utf8(_, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_wstr_to_utf8));
    ON_CALL(*this, cplat_utf8_to_wstr_alloc(_))
        .WillByDefault(Invoke(delegate_real_cplat_utf8_to_wstr_alloc));
    ON_CALL(*this, cplat_wstr_to_utf8_alloc(_))
        .WillByDefault(Invoke(delegate_real_cplat_wstr_to_utf8_alloc));

    // cplat/base/error.h
    ON_CALL(*this, cplat_error_capture_windows_error(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_error_capture_windows_error));
    ON_CALL(*this, cplat_error_capture_current_windows_error(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_capture_current_windows_error));
    ON_CALL(*this, cplat_error_get_windows_error(_))
        .WillByDefault(Invoke(delegate_real_cplat_error_get_windows_error));

    // cplat/trace/etw.h
    ON_CALL(*this, cplat_etw_provider_create(_))
        .WillByDefault(Invoke(delegate_real_cplat_etw_provider_create));
    ON_CALL(*this, cplat_etw_provider_write(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_etw_provider_write));
    ON_CALL(*this, cplat_etw_provider_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_etw_provider_dispose));
    ...
    ON_CALL(*this, cplat_etw_session_stop(_))
        .WillByDefault(Invoke(delegate_real_cplat_etw_session_stop));

    // cplat/trace/eventlog.h
    ON_CALL(*this, cplat_eventlog_sink_create(_))
        .WillByDefault(Invoke(delegate_real_cplat_eventlog_sink_create));
    ...
    // cplat/win32/win32.h
    ON_CALL(*this, CreateFileU(_, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_CreateFileU));
    ON_CALL(*this, CreateNamedPipeU(_, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_CreateNamedPipeU));
    ON_CALL(*this, GetModuleFileNameU(_, _, _))
        .WillByDefault(Invoke(delegate_real_GetModuleFileNameU));
    ON_CALL(*this, WriteConsoleU(_, _, _, _, _)).WillByDefault(Invoke(delegate_real_WriteConsoleU));
    ON_CALL(*this, GetVolumePathNameU(_, _, _))
        .WillByDefault(Invoke(delegate_real_GetVolumePathNameU));
    ...
    ON_CALL(*this, CreateProcessU(_, _, _, _, _, _, _, _, _, _))
        .WillByDefault(Invoke(delegate_real_CreateProcessU));
    ...
    ON_CALL(*this, ChangeServiceConfig2U(_, _, _))
        .WillByDefault(Invoke(delegate_real_ChangeServiceConfig2U));
    ON_CALL(*this, RegisterServiceCtrlHandlerExU(_, _, _))
        .WillByDefault(Invoke(delegate_real_RegisterServiceCtrlHandlerExU));
    ON_CALL(*this, StartServiceCtrlDispatcherU(_))
        .WillByDefault(Invoke(delegate_real_StartServiceCtrlDispatcherU));
    ...
    ON_CALL(*this, cplat_syslog_sink_create(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_syslog_sink_create));
    ON_CALL(*this, cplat_syslog_sink_write(_, _, _, _))
        .WillByDefault(Invoke(delegate_real_cplat_syslog_sink_write));
    ON_CALL(*this, cplat_syslog_sink_rename(_, _))
        .WillByDefault(Invoke(delegate_real_cplat_syslog_sink_rename));
    ON_CALL(*this, cplat_syslog_sink_dispose(_))
        .WillByDefault(Invoke(delegate_real_cplat_syslog_sink_dispose));
