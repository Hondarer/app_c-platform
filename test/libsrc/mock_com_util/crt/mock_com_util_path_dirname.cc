               ...
               const char *path)
{
    ...
    {
        mock_ret = _mock_com_util->com_util_path_dirname(path_out, path_size, detail_out, path);
    }
    else
    {
        mock_ret = delegate_real_com_util_path_dirname(path_out, path_size, detail_out, path);
    }
