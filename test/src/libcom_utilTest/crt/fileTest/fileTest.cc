...
TEST_F(fileTest, write_persists_buffer_and_allows_reopen)
{
    // Arrange
...
TEST_F(fileTest, file_id_differs_after_path_is_recreated)
{
    // Arrange
...
TEST_F(fileTest, stdio_wrappers_report_success)
{
    // Arrange
