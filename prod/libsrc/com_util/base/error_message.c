...
const char *com_util_result_to_string(const int result)
{
    const char *text;
    ...
    case COM_UTIL_OK:
        text = "success";
        break;
    case COM_UTIL_ERR_UNKNOWN:
        text = "unknown error";
        break;
    case COM_UTIL_ERR_INVALID_ARGUMENT:
        text = "invalid argument";
        break;
    case COM_UTIL_ERR_UNSUPPORTED:
        text = "unsupported";
        break;
    case COM_UTIL_ERR_PERMISSION_DENIED:
    ...
    case COM_UTIL_ERR_OUT_OF_MEMORY:
        text = "out of memory";
        break;
    case COM_UTIL_ERR_BUSY:
        text = "resource busy";
        break;
    case COM_UTIL_ERR_TIMEOUT:
        text = "timeout";
        break;
    case COM_UTIL_ERR_LIMIT_EXCEEDED:
        text = "limit exceeded";
        break;
...
int com_util_errno_message(char *buf, const size_t buf_size, const int errno_value)
{
...
int com_util_win32_error_message(char *buf, const size_t buf_size, const unsigned long error_code)
{
    ...
    utf8 = com_util_wstr_to_utf8_alloc(wmessage);
    LocalFree(wmessage);
    if (utf8 == NULL)
    {
        return COM_UTIL_ERR_UNKNOWN;
