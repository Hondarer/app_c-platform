...
int test_process_setup_child_stdio_one(const cplat_process_stdio *spec, int target_fd, int null_flags)
{
    return setup_child_stdio_one(spec, target_fd, null_flags);
}

int test_process_setup_child_stdio(const cplat_process_options *options)
{
...
int test_process_run_child(const cplat_process_options *options, char *const *envp)
{
