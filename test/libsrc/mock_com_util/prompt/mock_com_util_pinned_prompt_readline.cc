               ...
               const char *prompt_str, const char *file, int line)
{
    ...
    {
        mock_ret = _mock_com_util->com_util_pinned_prompt_readline_at(screen, buf, buf_size, prompt_str, file, line);
    }
    else
    {
        mock_ret = delegate_real_com_util_pinned_prompt_readline_at(screen, buf, buf_size, prompt_str, file, line);
    }
