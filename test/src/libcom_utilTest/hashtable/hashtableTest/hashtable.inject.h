...
extern "C"
{
    ...
    extern void *test_hashtable_value_free_list(const com_util_hashtable *ht);
    extern uint64_t test_hashtable_value_free_count(const com_util_hashtable *ht);
    extern void test_hashtable_set_value_free_count(com_util_hashtable *ht, uint64_t count);
