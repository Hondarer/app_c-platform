...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_local_lock_lock, (mtx, timeout_ms), com_util_local_lock_t *mtx, uint32_t timeout_ms)
...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_condvar_wait, (cv, mtx, timeout_ms), com_util_condvar_t *cv, com_util_local_lock_t *mtx, uint32_t timeout_ms)
...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_local_rwlock_lock_shared, (rwlock, timeout_ms), com_util_local_rwlock_t *rwlock, uint32_t timeout_ms)
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_local_rwlock_try_lock_shared, (rwlock), com_util_local_rwlock_t *rwlock)
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_local_rwlock_lock_exclusive, (rwlock, timeout_ms), com_util_local_rwlock_t *rwlock, uint32_t timeout_ms)
...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_interprocess_lock_lock, (lock, timeout_ms), com_util_interprocess_lock_t *lock, uint32_t timeout_ms)
...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_interprocess_rwlock_lock_shared, (lock, timeout_ms), com_util_interprocess_rwlock_t *lock, uint32_t timeout_ms)
...
DEFINE_SYNC_RET(com_util_sync_result_t, com_util_interprocess_rwlock_lock_exclusive, (lock, timeout_ms), com_util_interprocess_rwlock_t *lock, uint32_t timeout_ms)
