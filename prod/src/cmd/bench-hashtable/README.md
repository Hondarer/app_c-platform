...
- [hashtable 可変長ストレージの管理方式](../../../../docs/hashtable-storage-allocator.md) - 空きリストの仕組みと計算量
...
結論の根拠として引用する数値は [hashtable 可変長ストレージの管理方式](../../../../docs/hashtable-storage-allocator.md) へ転記します。  
