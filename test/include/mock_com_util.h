...
// sync
extern com_util_sync_result_t delegate_real_com_util_mutex_create(com_util_mutex_t **mtx);
extern com_util_sync_result_t delegate_real_com_util_mutex_lock(com_util_mutex_t *mtx, uint32_t timeout_ms);
extern com_util_sync_result_t delegate_real_com_util_mutex_try_lock(com_util_mutex_t *mtx);
extern com_util_sync_result_t delegate_real_com_util_mutex_unlock(com_util_mutex_t *mtx);
extern void delegate_real_com_util_mutex_destroy(com_util_mutex_t *mtx);
extern com_util_sync_result_t delegate_real_com_util_condvar_create(com_util_condvar_t **cv);
extern com_util_sync_result_t delegate_real_com_util_condvar_wait(com_util_condvar_t *cv, com_util_mutex_t *mtx, uint32_t timeout_ms);
...
extern com_util_sync_result_t delegate_real_com_util_rwlock_create(com_util_rwlock_t **rwlock);
extern com_util_sync_result_t delegate_real_com_util_rwlock_lock_shared(com_util_rwlock_t *rwlock, uint32_t timeout_ms);
extern com_util_sync_result_t delegate_real_com_util_rwlock_try_lock_shared(com_util_rwlock_t *rwlock);
extern com_util_sync_result_t delegate_real_com_util_rwlock_lock_exclusive(com_util_rwlock_t *rwlock, uint32_t timeout_ms);
extern com_util_sync_result_t delegate_real_com_util_rwlock_try_lock_exclusive(com_util_rwlock_t *rwlock);
extern com_util_sync_result_t delegate_real_com_util_rwlock_unlock_shared(com_util_rwlock_t *rwlock);
extern com_util_sync_result_t delegate_real_com_util_rwlock_unlock_exclusive(com_util_rwlock_t *rwlock);
extern void delegate_real_com_util_rwlock_destroy(com_util_rwlock_t *rwlock);
...
extern com_util_sync_result_t delegate_real_com_util_app_lock_create(const char *identity, com_util_app_lock_t **lock);
extern com_util_sync_result_t delegate_real_com_util_app_lock_open(const char *identity, com_util_app_lock_t **lock);
extern com_util_sync_result_t delegate_real_com_util_app_lock_import_descriptor(const void *descriptor, size_t descriptor_size, com_util_app_lock_t **lock);
extern com_util_sync_result_t delegate_real_com_util_app_lock_export_descriptor(const com_util_app_lock_t *lock, void *descriptor, size_t *descriptor_size);
extern com_util_sync_result_t delegate_real_com_util_app_lock_lock_shared(com_util_app_lock_t *lock, uint32_t timeout_ms);
extern com_util_sync_result_t delegate_real_com_util_app_lock_try_lock_shared(com_util_app_lock_t *lock);
extern com_util_sync_result_t delegate_real_com_util_app_lock_lock_exclusive(com_util_app_lock_t *lock, uint32_t timeout_ms);
extern com_util_sync_result_t delegate_real_com_util_app_lock_try_lock_exclusive(com_util_app_lock_t *lock);
extern com_util_sync_result_t delegate_real_com_util_app_lock_unlock(com_util_app_lock_t *lock);
extern void delegate_real_com_util_app_lock_destroy(com_util_app_lock_t *lock);
...
class Mock_com_util
{
  public:
    ...
    // sync
    MOCK_METHOD(com_util_sync_result_t, com_util_mutex_create, (com_util_mutex_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_mutex_lock, (com_util_mutex_t *, uint32_t));
    MOCK_METHOD(com_util_sync_result_t, com_util_mutex_try_lock, (com_util_mutex_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_mutex_unlock, (com_util_mutex_t *));
    MOCK_METHOD(void, com_util_mutex_destroy, (com_util_mutex_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_condvar_create, (com_util_condvar_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_condvar_wait, (com_util_condvar_t *, com_util_mutex_t *, uint32_t));
    ...
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_create, (com_util_rwlock_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_lock_shared, (com_util_rwlock_t *, uint32_t));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_try_lock_shared, (com_util_rwlock_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_lock_exclusive, (com_util_rwlock_t *, uint32_t));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_try_lock_exclusive, (com_util_rwlock_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_unlock_shared, (com_util_rwlock_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_rwlock_unlock_exclusive, (com_util_rwlock_t *));
    MOCK_METHOD(void, com_util_rwlock_destroy, (com_util_rwlock_t *));
    ...
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_create, (const char *, com_util_app_lock_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_open, (const char *, com_util_app_lock_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_import_descriptor, (const void *, size_t, com_util_app_lock_t **));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_export_descriptor, (const com_util_app_lock_t *, void *, size_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_lock_shared, (com_util_app_lock_t *, uint32_t));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_try_lock_shared, (com_util_app_lock_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_lock_exclusive, (com_util_app_lock_t *, uint32_t));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_try_lock_exclusive, (com_util_app_lock_t *));
    MOCK_METHOD(com_util_sync_result_t, com_util_app_lock_unlock, (com_util_app_lock_t *));
    MOCK_METHOD(void, com_util_app_lock_destroy, (com_util_app_lock_t *));
